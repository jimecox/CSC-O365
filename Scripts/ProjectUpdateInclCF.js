// update project level values incl custom field values
...
//alert("r2 ProjectUpdateInclCF")  // this will auto run when page is loaded to prove page is fresh
